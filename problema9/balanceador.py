...
class LoadBalancer:
    ...
    def start(self):
        ...
        print("="*50)
        print("⚖️ BALANCEADOR DE CARGA")
        print("="*50)
        print("✅ Registro de backends")
        print("✅ Health checks (heartbeats)")
        print("✅ Distribución round-robin")
        print("✅ Sincronización de datos")
        print("="*50)
                ...
                for backend_addr, info in list(self.backends.items()):
                    ...
                    if now - info['last_heartbeat'] > 10:
                        if info['status'] == 'healthy':
                            ...
                            print(f"⚠️ Backend {backend_addr} no responde")
